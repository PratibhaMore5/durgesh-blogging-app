...
public class PostController {
	...
	public ResponseEntity<PostResponse> getAllPostResponse(
		...
		PostResponse postResponse = this.postService.getAllPostResponse(pageNumber, pageSize, sortBy, sortDir);
	...
	public ResponseEntity<PostDto> uploadPostImage(@RequestParam("image") MultipartFile image,
		...
		String filleName = this.fileService.uploadImage(path, image);
		postDto.setImageName(filleName);
		PostDto updatePost = this.postService.updatePost(postDto, postId);
		return new ResponseEntity<PostDto>(updatePost, HttpStatus.OK);
	}
